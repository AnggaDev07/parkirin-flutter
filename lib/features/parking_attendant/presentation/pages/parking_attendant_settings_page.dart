// lib/features/parking_attendant/presentation/pages/parking_attendant_settings_page.dart
...
class ParkingAttendantSettingsPage extends StatelessWidget {
  const ParkingAttendantSettingsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ParkingAttendantSettingsContent();
  }
}

class _ParkingAttendantSettingsContent extends StatefulWidget {
  const _ParkingAttendantSettingsContent();

  @override
  State<_ParkingAttendantSettingsContent> createState() =>
      _ParkingAttendantSettingsContentState();
}

class _ParkingAttendantSettingsContentState
    extends State<_ParkingAttendantSettingsContent> {
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      _pushNotifications = prefs.getBool('attendantPushNotifications') ?? true;
    });
  }
  ...
  Future<void> _saveSettings() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('attendantPushNotifications', _pushNotifications);
  }
